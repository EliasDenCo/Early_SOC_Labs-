...
SOC Level 1>Cyber Defence Frameworks>Pyramid Of Pain RM8: Solid room, definitely a deep dive into understanding the paths and techniques used by attackers to gain access into a network and platform. It was a tougher one, although that may have just been because I have been distracted with trying to find a position in cybersecurity and have not had as much time to actually study as I would like to. Understanding the pyramid seems crucial to grasp the tactics and patterns put forth by attackers and it was fun to learn about "fuzzy hashing" and TTPs used to gain accesses into systems and networks. It seems that the ATT&CK Matrix webpage is a deep well of knowledge that one could access to find out way more than any one person could ever know about adversary tactics and techniques used by attackers. Overall it was fun.
